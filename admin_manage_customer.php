...
<html>
    <head>
        <title>Registered Customer Page</title>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="admin_manage_customer.php">Manage Customers</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="wrap">
            <form class="search-bar" method="GET">
                <input type="text"  name="search_keyword" placeholder="Search for customers">
        ...
        <?php
            ...
            $sql = "SELECT * FROM customer_record WHERE customerID LIKE '%".$searchkeyword."%' OR customerEmail LIKE '%".$searchkeyword."%' 
            OR customerFullname LIKE '%".$searchkeyword."%' OR customerIC LIKE '%".$searchkeyword."%' OR customerPhoneNumber LIKE '%".$searchkeyword."%'
            OR customerAddress LIKE '%".$searchkeyword."%' OR customerGender LIKE '%".$searchkeyword."%'";
              ...
              <table class="level1-table">
                ...
                echo    '<tr>
                      ...
                      echo '</td>
                        ...
                        if($row['customer_status']=='Active'){
                            echo '<form action="deactivate_customer.php" method="post">
                                    <input type="hidden" name="customerID" value="'.$row['customerID'].'">
                                    <button type="submit" class="red-button"  onclick="return confirm(\'Deactivate '.$row['customerFullname'].'?\')">Deactivate</button>
                                </form>';
                        }else{
                            echo '<form action="activate_customer.php" method="post">
                                    <input type="hidden" name="customerID" value="'.$row['customerID'].'">
                                    <button type="submit" class="green-button" onclick="return confirm(\'Activate '.$row['customerFullname'].'?\')">Activate</button>
                                 </form>';
                        }
