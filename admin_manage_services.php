...
<html>
    <head>
        <title>Manager Services Page</title>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <p>Purrfect Care Services<p>
        <a href="add_service_admin.php"><input type="submit" value="Add New Service" name="add_service_btn" class="add-service"/></a>
        <a href="view_main_service.php"><input type="submit" value="View Main Service" name="add_service_btn" class="add-service"/></a>
        <?php
        $con = mysqli_connect("localhost","root","","purrfect_care");
        $sql = "SELECT main_services.mainServiceID, main_services.serviceName, service_record.serviceID
        FROM main_services
        LEFT JOIN service_record ON main_services.mainServiceID = service_record.mainServiceID GROUP BY  main_services.serviceName";
        ...
        ?>
            <div class="card-container">
                ...
                '<div class="card">
                  ...
                  <div class="book">
                  <a href="view_edit_service.php?mainServiceID='.$row['mainServiceID'].'" class="staff-button">Service Details List</a>
                  <a href="add_service_type.php?mainServiceID='.$row['mainServiceID'].'" class="staff-button">Add Service Type</a>
                  </div>
                </div>';
                }
                ?>
