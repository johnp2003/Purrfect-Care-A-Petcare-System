...
<html>
    <head>
        <title>Add New Main Service</title>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
          ...
          <?php
           ...
           if (isset($_POST['submitBTN'])){
            ...
            $insert = "INSERT INTO main_services(serviceName, serviceLocation, serviceStartTime, serviceEndTime ) 
                        VALUES('$serviceName','$serviceLocation','$serviceStartTime','$serviceEndTime')";

            $confirm = mysqli_query($con,$insert);
            if($confirm == true){
                echo "<script>alert('Service added.');window.location.href='admin_manage_services.php';</script>";
        ...
        <p>Add New Service<p>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="serviceName" required maxlength="50" pattern="[A-Za-z ]+" placeholder="Enter service name">
                <span class="note">Note: Please add the subservices in the manage services page.</span>

                <label>Service Location:</label>
                <input type="text" name="serviceLocation" required="required" placeholder="Enter service location">

                <label>Service Start Time:</label>
                <input type="text" name="serviceStartTime" required="required" pattern="^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$" placeholder="Enter service start time in 24hour format (exp:10:30)">
              
                <label>Service End Time:</label>
                <input type="text" name="serviceEndTime" required="required" pattern="^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$" placeholder="Enter service end time in 24hour format (exp:10:30)">
